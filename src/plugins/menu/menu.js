...
export class MenuItem {
  ...
  render(view) {
    ...
    if (spec.title) {
      ...
      const titleAttr = translate(view, title)
      dom.setAttribute("title", titleAttr)
      // const tips = crel("div", { className: 'tips' }, translate(view, title))
      ...
      if (titleAttr) {
        dom.addEventListener("mouseenter", e => {
          ...
          let tips = parent.querySelector('.tips')
          if (!tips) {
            tips = crel("div", { class: 'tips' }, titleAttr)
            parent.appendChild(tips)
          }
          // if () ProseMirror-menu-disabled
          if (!el.classList.contains(prefix+ '-disabled')) {
